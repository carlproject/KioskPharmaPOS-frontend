...
const Cart = () => {
  ...
  const decrementQuantity1 = () => setQuantity1(prev => (prev > 1 ? prev - 1 : 1));

  const incrementQuantity2 = () => setQuantity2(prev => prev + 1);
  const decrementQuantity2 = () => setQuantity2(prev => (prev > 1 ? prev - 1 : 1));
  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <div Name="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
