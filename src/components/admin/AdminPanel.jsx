          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-green-500">Product</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-green-500">Inventory</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-green-500">Analytics</span>
              </a>
            </li>
            <li>
              <a
