...
function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900 border-t-4"  style={{ borderColor: '#28A745' }}>
  <div className="mx-auto w-full overflow-hidden max-w-screen-xl p-4 py-6 lg:py-8">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Checacio™</a>. All Rights Reserved.
        </span>
